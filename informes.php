                ...
                <div class="cuadro">
                    <ul>
                        ...
                        <li>
                            ...
                            <li>
                                    <a href="viewinforme/infVentas.php"><i class="ti-pencil-alt"></i>Informe-VENTAS</a>
                                </li>
                                <li>
                                    <a href="viewinforme/infProve.php"><i class="ti-eye"></i>Informe-PROVEHEDORES</a>
                                </li>
                                <li>
                                    <a href="viewinforme/infProductos.php"><i class="ti-eye"></i>Informe-PRODUCTOS</a>
                                </li>
                                <li>
                                    <a href="viewinforme/infUser.php"><i class="ti-eye"></i>Informe-USUARIO</a>
                            </li>
...
<!-- holaaa -->
            <div>
               ...
               <h2> SELECCIONE EL MODULO</h2>
                <p>Por favor seleccionar el modulo el cual se le desea sacar un informe</p>
