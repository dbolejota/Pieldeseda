<?php
        ...
        if (!isset($result)) {
            ...
            foreach($result as $f){
                ...
                <tr>
                    ...
                    <td> <a href="../controlador/controlprove/eliminarproveedor.php?idproveedor='.$f['idproveedor'].'" class="btn btn-danger">Eliminar</a> </td>
                </tr>                           
    ...
    function cargaproveedor(){
        ...
        foreach ($result as $f) {
            ...
            <form action="../controlador/controlprove/modificarproveedor.php" method="POST">
                <div class="row">
