...
if (isset($_POST['email']) && isset($_POST['password'])) {
  ...
  $conexion = new Conexion();
   $conn = $conexion->get_conexion();  // almacenando el objeto de conexión resultante en la variable $conn. 
  // Esto permite utilizar la conexión para realizar operaciones con la base de datos, como consultas y actualizaciones.
